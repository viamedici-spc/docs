...
[*Component Configuration Models*](/glossary/#component-configuration-model) (shortly: Component Model).

A very powerful modeling concept is the [*Shared Configuration Models*](/glossary/#shared-configuration-model)
...
[*Rules*](/glossary/#rule) of the Shared Model can be accessed from there.
