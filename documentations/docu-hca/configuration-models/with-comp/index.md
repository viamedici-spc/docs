## 4.2 Configuration Model with components

When modeling a real-world product, its characteristics are mapped to
[*Attributes*](../../glossary/terms-modeling/#attribute).
In the example under consideration here, most Attributes for both "Truck"
and "Car" are identical.
Therefore, there is a "main component" ("Automobile"), which contains the common Attributes of "Car" and "Truck".
as shown in Figure 4-2.

For good modeling, it is important to think abstractly and detach yourself from the physical conditions.
We should not think in terms of physical components, but rather in terms of
[*Component Configuration Models*](../../glossary/terms-modeling/#component-configuration-model) (shortly: Component Model).

A very powerful modeling concept is the [*Shared Configuration Models*](../../glossary/terms-modeling/#shared-configuration-model)
(shortly: Shared Model), which can be used to avoid redundancies.
A Shared Configuration Model can be integrated into any Component Model. The Attributes and
[*Rules*](../../glossary/terms-modeling/#configuration-rule) of the Shared Model can be accessed from there.


![](ConfigurationModelCar.png "The Car Configuration Model diagram")
Fig. 4-2: Structure of the Configuration Model for a car configuration

In a JSON representation, all Attributes appear within a single Configuration Model.
The following code example shows the Car Configuration Model in JSON representation.
