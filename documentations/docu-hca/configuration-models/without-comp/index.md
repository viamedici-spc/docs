...
In this simple case, only one [*Configuration Model*](../../glossary/terms-modeling/#configuration-model) with all Attributes is created. If a passenger car is to be configured,
a [*Rule*](../../glossary/terms-modeling/#configuration-rule) is used to ensure that "Sleeping cabin" is not available. In the case of a truck, "Over size" is
