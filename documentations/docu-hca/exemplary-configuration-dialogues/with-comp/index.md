...
the possibility of using [*Component Configuration Models*](../../glossary/terms-modeling/#component-configuration-model) and
[*Shared Configuration Models*](../../glossary/terms-modeling/#shared-configuration-model).
Due to its complexity, this chapter is subdivided.
The [*Configuration Dialogue*](../../glossary/terms-infrastructure/#configuration-dialogue)  is considered in [6.2.1](../with-comp/dialogue/#dialogue).
The [*Rules*](../../glossary/terms-modeling/#configuration-rule) of the entire
[*Configuration Model*](../../glossary/terms-modeling/#configuration-model) are summarised in [6.2.2](../with-comp/rules/#rules).
Subchapter [6.2.3](../with-comp/consequences/#consequences) contains the
[*Consequences*](../../glossary/terms-state/#consequence)
of the [*Decisions*](../../glossary/terms-state/#decision) made by an imaginary [*Configurator*](../../glossary/terms-infrastructure/#configurator).

The [*Configuration Session*](../../glossary/terms-infrastructure/#configuration-session) is initialized with the following request:
