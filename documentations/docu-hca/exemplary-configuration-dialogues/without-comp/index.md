...
We assume that the [*Session*](../../glossary/terms-infrastructure/#session) was initialized using the simple
[*Configuration Model*](../../glossary/terms-modeling/#configuration-model) ["SimpleCar"](/basic-workflow/initialization/#simple-car).

Now a first  [*Decision*](../../glossary/terms-state/#decision) can be done. For example, the Value of the Attribute
"CO2Emissions" is set to 100 (a [*Numeric Decision*](../../glossary/terms-state/#numeric-decision)):
```
...
```
According to the [*Constraint*](../../glossary/terms-modeling/#constraint):
...
[*Configuration Model-Satisfaction State*](../../glossary/terms-state/#configuration-model-satisfaction-state) becomes *true* .
...
```
The response delivers the Consequences which need to be evaluate by a [*Configurator*](../../glossary/terms-infrastructure/#configurator).
...
there are no [*Rejected Decisions*](../../glossary/terms-state/#rejected-decision).
