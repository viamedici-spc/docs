## 7. Restore a Configuration State
...
Problems can occur if the [*Configuration Model*](../glossary/terms-modeling/#configuration-model) has been changed in the meantime.
