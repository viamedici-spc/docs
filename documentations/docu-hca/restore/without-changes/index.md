...
At first we want to restore a previous [*Configuration State*](../../glossary/terms-state/#configuration-state) without any
changes in the [*Configuration Model*](../../glossary/terms-modeling/#configuration-model).

The route is used that enables  many [*Decisions*](../../glossary/terms-state/#decision) to be transmitted with one request.
...
```
[*Decisions*](../../glossary/terms-state/#decision) are now being made that have already been made in the past as part of
a [*Configuration Dialogue*](../../glossary/terms-infrastructure/#configuration-dialogue). This is necessary as part of the typical use case
"Load [*Configuration Project*](../../glossary/terms-infrastructure/#configuration-project)".
...
If the [*Configurator*](../../glossary/terms-infrastructure/#configurator) has already made Decisions before such a
[*Multiple Decision*](../../glossary/terms-state/#multiple-decision), these must be discarded in the
...
As there were no changes to the Configuration Model, no [*Conflicts*](../../glossary/terms-state/#conflict) can occur.
Therefore, the type of [*Conflict Resolution*](../../glossary/terms-state//#conflict-resolution) does not matter (*"Manual"* or *"Automatic"*.
...
None of the ten Decisions above were rejected by the [*Configuration Engine*](../../glossary/terms-infrastructure/#configuration-engine),
