...
Now it is assumed that the [*Configuration Model*](../../glossary/terms-modeling/#configuration-model) has been changed. Various use cases are considered:
...
[*7.2.3*](rule-added/#rule-added) One [*Rule*](../../glossary/terms-modeling//#configuration-rule) has been added.
...
A [*Configuration Session*](../../glossary/terms-infrastructure/#configuration-session) must also be initialized first when restoring
...
```
As a result of changes in a Configuration Model, [*Conflicts*](../../glossary/terms-state/#conflict) may occur when attempting
to restore a previous [*Configuration State*](../../glossary/terms-state/#configuration-state). The very powerful
