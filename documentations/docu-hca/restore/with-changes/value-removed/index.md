...
[Configuration Model](../../../configuration-models//with-comp#car-model) "Car" so that only 2 Values remain.
...
The [*Decisions*](../../../glossary/terms-state/#decision) that now need to be set are the 10 Decisions of the
...
A single request can be used to transmit multiple Decisions.

The example request with the 10 Decisions can be seen [here](../the-many-decisions-request/#ten-decisions).
...
The [Session-create request](../#session-create-car) is executed with the modified Configuration Model.
