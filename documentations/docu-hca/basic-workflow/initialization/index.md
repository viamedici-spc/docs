...
From a technical point of view, a [*Configuration Dialogue*](../../glossary/terms-infrastructure/#configuration-dialogue) needs to be initialized.
...
The initialization starts with a POST request to create a [*Configuration Session*](../../glossary/terms-infrastructure/#session) for
the [*Configuration Dialogue*](../../glossary/terms-infrastructure/#configuration-dialogue).
There are two ways to make a [*Configuration Model*](../../glossary/terms-modeling/#configuration-model), which generally consists of several
...
[*Configuration Projects*](../../glossary/terms-infrastructure/#configuration-project) are managed in the
Configuration Model Developer - see the documentation "Configuration Model Developer".
...
After a Configuration Session has been created, it must be ensured that a [*Configurator*](../../glossary/terms-infrastructure/#configurator) can display the available Attributes and
their initial [*Value Decision States*](../../glossary/terms-state/#value-decision-state). For this purpose,
the [*Consequences*](../../glossary/terms-state/#consequence) and the
[*Implicit Decisions*] (../../glossary/terms-state/#implicit-decisions) resulting from the initial evaluation of the
...
The response with the code *200* delivers the [*Choice Consequences*](../../glossary/terms-state/#choice-consequence), the
[*Numeric Consequences*](../../glossary/terms-state/#numeric-consequence),
the [*Boolean Consequences*](../../glossary/terms-state/#boolean-consequence) and the
[*Component Consequences*](../../glossary/terms-state/#component-consequence).
At the beginning of the JSON structure the [*Configuration Model-Satisfaction State*](../../glossary/terms-state/#configuration-model-satisfaction-state) is given ("isSatisfied": false).
In the result of the initial [*Constraint*](../../glossary/terms-modeling/#constraint) evaluation,
the [*Value Decision State*](../../glossary/terms-state/#value-decision-state) for
the value *Car* of the Attribute *Construction* is *Included*, while the value *Truck* is *Excluded*.
The inclusion is the result of an [*Implicit Decisions*](../../glossary/terms-state/#implicit-decision) that lead to
the [*Attribute Satisfaction State*](../../glossary/terms-state/#attribute-satisfaction-state) being *true*.
The Values of the other Attributes have the [*Possible Decision States*](../../glossary/terms-state/#possible-decision-state) *Included* and *Excluded*.
...
[*Choice Decisions*](../../glossary/terms-state/#choice-decision), the
[*Numeric Decisions*](../../glossary/terms-state/#numeric-decision), the
[*Boolean Decisions*](../../glossary/terms-state/#boolean-decision) and the
[*Component Decisions*](../../glossary/terms-state/#component-decision).
...
An exemplary visualization of the initial [*Configuration State*](../../glossary/terms-state/#configuration-state) is shown in figure 5-3.
