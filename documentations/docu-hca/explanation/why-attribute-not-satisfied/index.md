## 8.1 Why an Attribute is not satisfied
...
During the restoring of the [*Configuration State*](../../glossary/terms-state/#configuration-state) shown above, this change in the declaration of
the  Attribute "Customer category" is not taken into account.

During the restoring the following request with a [*Multiple Decision*](../../glossary/terms-state/#multiple-decision)
is executed:
...
```
The [*Cardinality*](../../glossary/terms-modeling/#cardinality) of the "CustomerCategory" Attribute that was changed to (1:1)
