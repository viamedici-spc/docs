...
A [*Configuration Model*](../glossary/terms-modeling/#configuration-model) can be very complex.
...
[*Attribute Values*](../glossary/terms-modeling/#attribute-value) that are not possible in a current situation
due to the [*Configuration Rules*](../glossary/terms-modeling/#configuration-rule) cannot be assigned.
It is extremely advantageous for use if an explanation can be called up for this.

Sometimes all [*Configuration Attributes*](../glossary/terms-modeling/#attribute) are assigned Values,
