...
All [*Attributes*](../../glossary/terms-modeling/#attribute) are satisfied. But - as shown the Consequences -
the [*Configuration Model*](../../glossary/terms-modeling/#configuration-model) as a whole is not satisfied yet.
Why not?

Get the [*Consequences*](../../glossary/terms-state/#consequence):
...
This is caused by [*Rule*](../../glossary/terms-modeling/#rule) 16, which requires that either the
[*Component Attribute*](../../glossary/terms-modeling/#component-attribute) "SpareWheel"  is selected or the
[*Boolean Attribute*](../../glossary/terms-modeling/#boolean-attribute) "Tubeless" is set to "true".
