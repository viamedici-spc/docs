...
The initial situation after calling up the [*Configurator*](../../glossary/terms-infrastructure/#configurator):

The Attributes of the instance of the [*Component Configuration Model*](../../glossary/terms-modeling/#component-configuration-model) "Wheel"
...
Reminder: Both are [*Implicit Decisions*](../../glossary/terms-state/#implicit-decision) of the
[*Configuration Engine*](../../glossary/terms-infrastructure/#configuration-engine) because of the [*Rules*](../../glossary/terms-modeling/#configuration-rule):
[*Rule 19*](../../exemplary-configuration-dialogues/with-comp/rules/#rule19), [*Rule 24*](../../exemplary-configuration-dialogues/with-comp/rules/#rule24)
...
The Configuration Engine should now provide an [*Explanation*](../../glossary/terms-state/#explanation) as to why the
...
As you can see in Figure 8-y, "Kind" is a [*Choice Attribute*](../../glossary/terms-modeling/#choice-attribute) for which
exactly one Value must be assigned. Since only one Value is available, the Configuration Engine makes a
corresponding [*Implicit Decision*](../../glossary/terms-state/#implicit-decision).
