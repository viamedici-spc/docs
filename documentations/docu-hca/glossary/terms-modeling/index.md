...
## 2.2 Terms relating to Configuration Modeling
...
In the context of the [*Configuration Engine*](../terms-infrastructure/#configuration-engine) there is a special Attribute type "Component".
...
### Component Attribute
*Component Attribute* is a special Attribute type in the context of the [*Configuration Engine*](../terms-infrastructure/#configuration-engine).
...
[*Shared Configuration Models*](#shared-configuration-model) it serves a the starting point
for processing by the [*Configuration Engine*](../terms-infrastructure/#configuration-engine).
The name of the Root Configuration Model must be specified in the body of the POST request
for [*Session*](../terms-infrastructure/#configuration-session) creation.


<a name ="component"></a>
### Component
*Component* is in the modeling context a synonym for [*Component Configuration Model*](#component-configuration-model).
